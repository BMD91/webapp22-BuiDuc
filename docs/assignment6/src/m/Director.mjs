...
class Director extends Person {
  ...
  toString() {
    return `Director{ persID: ${this.personId}, name: ${this.name}, biography: ${this.biography} }`;
  }
}
/*****************************************************
 ...
 */
Director.update = function ({personId, name, biography}) {
  ...
  try {
    ...
    if (biography && director.biography !== biography) {
